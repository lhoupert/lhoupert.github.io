...
The first step towards removing this babysitting work is to move the crontab line moves into Argo Workflows. The ingest script itself does not change at all, but we add two things in the orchestration around it: 
...
I find that writing things down also has a lot of value on its own! It is one of the fastest way I know to find out which parts I only half understood (it happened more than once while writing this post 😅), and, as I experienced at FOSS4G, sharing what you learnt is a great way to start conversations that would never have happened otherwise!
