...
If you want to know more about "self-healing" geospatial data pipelines, my talk is here: [From Cron Job to Self-Healing Pipeline](https://talks.osgeo.org/foss4g-europe-2026/talk/JFCDW9/), and the companion repo is on GitHub: [lhoupert/argo-stac-eo-pipeline](https://github.com/lhoupert/argo-stac-eo-pipeline). I'll write more about how I built it in a future post.
